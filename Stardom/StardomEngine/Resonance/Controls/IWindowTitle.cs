  ...
  //      {
    ...
    //    }
        ...
        public override void Render()
        {
            ...
            GameUI.This.DrawRect(bg, RenderPosition, Size, new OpenTK.Mathematics.Vector4(Color.X,Color.Y,Color.Z, 1), 0.003f, true, GameUI.Theme.Frame, 0, Refracter);
            GameUI.This.DrawRect(GameUI.Theme.WindowTitle, RenderPosition, Size, new Vector4(Color.X,Color.Y,Color.Z, 0.85f)); ;
